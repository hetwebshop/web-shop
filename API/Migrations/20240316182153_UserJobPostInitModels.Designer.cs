...
namespace API.Migrations
{
    ...
    [Migration("20240316182153_UserJobPostInitModels")]
    partial class UserJobPostInitModels
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.Canton", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API.Entities.JobPost.JobSubcategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API.Entities.City", b =>
                {
                    b.HasOne("API.Entities.Canton", "Canton")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("API.Entities.JobPost.JobSubcategory", b =>
                {
                    b.HasOne("API.Entities.JobPost.JobCategory", "Category")
            ...
            modelBuilder.Entity("API.Entities.JobPost.UserJobPost", b =>
                {
                    b.HasOne("API.Entities.UserAddress", "Address")
                        .WithOne()
                        .HasForeignKey("API.Entities.JobPost.UserJobPost", "AddressId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("API.Entities.JobPost.JobSubcategory", "JobSubcategory")
                        .WithMany()
